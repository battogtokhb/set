...
class SetCardContainerView: UIView {
    ...
    func layoutCards () {
        ...
        UIViewPropertyAnimator.runningPropertyAnimator(
            ...
            options: [],
            animations: {
                for (index, card) in self.playingCards.enumerated() {
            ...
            completion: {_ in self.animateDealtCards() }
        )
    }
            ...
            UIViewPropertyAnimator.runningPropertyAnimator(
                ...
                completion: { _ in
                    UIView.transition(with:
                        card, duration: Animation.flipDuration, options: .transitionFlipFromLeft, animations: { card.isFaceUp = true}, completion: { _ in  card.toDeal = false})
                }
            )
        }
    }
